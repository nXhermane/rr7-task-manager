    ...
    <>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-4">
          ...
          <select
            className="px-4 py-3 bg-slate-800 border border-slate-700 rounded-lg focus:outline-none focus:border-blue-500 transition"
            id="filter-status"
          >
        ...
        <div className="flex items-center space-x-2">
          <Button
            className="p-3 bg-slate-800 border border-slate-700 rounded-lg hover:border-blue-500 transition"
            title="Vue liste"
          >
            <svg
              className="w-5 h-5"
